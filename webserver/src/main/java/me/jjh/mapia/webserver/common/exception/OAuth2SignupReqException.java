 ...
 */
public class OAuth2SignupReqException extends OAuth2AuthenticationException {
    private final OAuth2Response oAuth2Response;

    public OAuth2SignupReqException(String message, OAuth2Response oAuth2Response) {
        super(message);
